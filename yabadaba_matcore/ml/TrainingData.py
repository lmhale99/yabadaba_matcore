...
class TrainingData(Record):
    ...
    def _init_values(self):
        ...
        self._add_value('str', 'contents', valuerequired=True,
        ...
        self._add_value('str', 'data_preprocessing', modelpath='data-preprocessing',
        ...
        self._add_value('str', 'dataset_split', modelpath='dataset-split',
