...
class DielectricMatrix(Record):
    ...
    def _init_values(self):
        ...
        self._add_value('float', 'planewave_basis_cutoff',
                        valuerequired = True,
                        modelpath = 'planewave-basis-cutoff',
                        #unit = 'Ry',
        ...
        self._add_value('str', 'local_orbital_basis_set',
                        valuerequired = True,
                        modelpath = 'local-orbital-basis-set',
        ...
        self._add_value('int', 'response_basis_size',
                        modelpath = 'response-basis-size',
        ...
        self._add_value('intarray', 'q_points',
                        valuerequired = True,
                        modelpath = 'q-points',
                        shape = (3,),
                        description = 'Brillouin zone grid used for sampling the dielectric matrix.')
        
        self._add_value('str', 'coulomb_truncation',
                        modelpath = 'coulomb-truncation',
                        allowedvalues = (
                            'Ismail-Beigi',
                            'Rozzi',
                            'Spencer-Alavi'),
