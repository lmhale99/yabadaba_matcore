...
class ModelParameter(Record):
    ...
    """
    Class for Material Core PF "model-parameter" fields
    """
    ...
    def _init_values(self):
        ...
        self._add_value('str', 'name',
                        valuerequired = True,
                        description = 'The designation of the model parameter.')
        
        self._add_value('str', 'value',
                        valuerequired = True,
                        description = 'The data associated with the model parameter.')
        ...
        self._add_value('str', 'description',
                        description = 'An explanation providing further clarification on the model parameter.')
