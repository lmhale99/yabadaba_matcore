...
class ParticleInteractions(Record):
    ...
    def add_source(self, **kwargs):
        """Adds a source to the record"""
        self.get_value('source').append(**kwargs)

    def source_df(self):
        """Generates a pandas DataFrame of the source information"""
        return self.get_value('source').metadata_df()
