...
class SimulationConditions(Record):
    ...
    def _init_values(self):
        ...
        self._add_value('floatarray', 'stress', unit='Pa', shape=(6,),
        ...
        self._add_value('floatarray', 'strain', shape=(6,),
        ...
        self._add_value('floatarray', 'strain_rate', modelpath='strain-rate', shape=(6,),
        ...
        self._add_value('floatarray', 'heat_flux', modelpath='heat-flux', unit='W/m^2', shape=(3,),
                        description='The amount of thermal energy transferred to the material per unit area per unit time along a given direction.')
        self._add_value('floatarray', 'temperature_gradient', modelpath='temperature-gradient', unit='W/m^2', shape=(3,),
