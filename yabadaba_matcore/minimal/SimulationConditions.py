...
class SimulationConditions(Record):
    ...
    def _init_values(self):
        ...
        self._add_value('floatarray', 'stress', unit='Pa',
        ...
        self._add_value('floatarray', 'strain_rate', modelpath='strain-rate',
        ...
        self._add_value('floatarray', 'heat_flux', modelpath='heat-flux', unit='W/m^2',
